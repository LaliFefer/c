...
internal class CustomerImplementation : ICustomer
{
    ...
    public int Create(Customer item)
    {
        ...
        if (Read(item.IDNumber) != null)
        {
            ...
            throw new DalAlreadyExistsException($"Customer with ID {item.IDNumber} already exists.");
        }
    ...
    public void Update(Customer item)
    {
        ...
        if (existing == null)
        {
            ...
            throw new DalDoesNotExistException($"Customer with ID {item.IDNumber} does not exist.");
        }
